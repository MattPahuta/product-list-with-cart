function Cart() {
  return (
    <section className="p-6 rounded-xl bg-white sm:min-w-sm">
      ...
      <p className="mb-4 text-brand-rose-500 font-semibold text-center">Your added items will appear here</p>
    </section>
  );
}
